...
<div itemscope itemtype="http://schema.org/WebSite">
  ...
  <form
    action="/search/"
    data-vue-role="search-form"
    <?php if ($searchBlock->id) {
        echo 'data-v-bind_block-id="' . (int)$searchBlock->id . '" ' .
             'data-v-bind_min-length="' . (int)$searchBlock->min_length . '"';
    } ?>
    data-v-bind_foldable="false"
    class="search-form"
  ...
  >
    ...
    <button
      ...
      data-v-on_click.prevent.stop="vm.toggle()"
    ></button>
    <!--/nodesktop-->
