...
<div class="triggers triggers__list triggers-list" data-vue-role="triggers" data-v-slot="vm">
  ...
  <a href="#" class="triggers-list__item triggers-item triggers-item_filter" data-v-if="vm.filterActive" title="Фильтр каталога" data-v-on_click.stop.prevent="jqEmit('raas.shop.openfilter');"></a>
