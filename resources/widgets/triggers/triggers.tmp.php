...
?>
<div data-vue-role="triggers" data-vue-inline-template>
  <div class="triggers">
    <div class="triggers__list">
      <div class="triggers-list">
        ...
        <div class="triggers-list__item triggers-list__item_filter" data-v-if="filterActive" data-v-bind_class="filterClass">
          <a class="triggers-item triggers-item_filter" title="Фильтр каталога" data-v-on_click="openFilter($event);"></a>
        </div>
